...
class JT1078Parser:
    ...
    def parse_0104_message(self, message_bytes: bytes) -> Dict[str, Any]:
        ...
        result['message_type'] = '0x0104 - Device Command Response(ACK)'
        return result
...
def main():
    ...
    with col2:
        ...
        6. In parsed messages:
           ...
           - Temperature: In "°C"
           - Humidity: In "%"  
           - Device ID: It is the IMEI of device   
        """)
    ...
    if st.session_state.parsed_messages:
        ...
        for msg in st.session_state.parsed_messages:
            ...
            elif msg_type in ['0x0104 - Device Command Response(ACK)']:
